    ...
    return (
        <div>
            ...
            <div className="container">
                <a className="navbar-brand" href="#"><img className="logo" src={logo} alt="mahmoud"/></a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li className="nav-item active">
                        <a className="nav-link" href="#">Education <span className="sr-only">(current)</span></a>
                    </li>
                    <li className="nav-item active">
                        <a className="nav-link" href="#">Experience <span className="sr-only">(current)</span></a>
                    </li>
                    <li className="nav-item active">
